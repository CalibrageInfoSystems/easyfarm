...
public class DatabaseKeys {
    ...
    public static String col_ClassType_ClassTypeId ="ClassTypeId";
    public static String col_ClassType_Name ="Name";
    public static String col_ClassType_IsActive ="IsActive";
    public static String col_ClassType_CreatedByUserId ="CreatedByUserId";
    public static String col_ClassType_CreatedDate ="CreatedDate";
    public static String col_ClassType_UpdatedByUserId ="UpdatedByUserId";
    public static String TABLE_FORMER = "UserInfo";
    ...
    public static String TABLE_FERTLIZER_PROVIDER = "FertilizerProvider";
    ...
    public static String TABLE_IDENTITYPROOFS = "IdentityProofs";
    public static String TABLE_FARMERBANK = "BankDetails";
    public static String TABLE_PLANTATION = "Plantation";
    public static String TABLE_PLOTSTATUSHISTORY= "PlotStatusHistory";
    public static String TABLE_LANDLORDBANK = "BankDetailsHistory";
  ...
  public static String TABLE_BANKDetailsHistory = "BankDetailsHistory";
