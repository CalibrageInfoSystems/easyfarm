...
public class ConvertedBuyers extends AppCompatActivity {
    ...
    ConvertedBuyerAdapter recyclerAdapter;
    Toolbar toolbar;
    EditText et_search;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_converted_buyers);
    ...
    private void setViews() {
        ...
        mFarmersList = (List<Farmer>) dataAccessHandler.getfarmerDetails(Queries.getInstance().getConvertedBuyers(), 1);
        ...
        recyclerAdapter = new ConvertedBuyerAdapter(context,mFarmersList);
    ...
    public void doSearch(String searchQuery) {
        ...
        if (!TextUtils.isEmpty(searchQuery)) {
            ...
            if (recyclerAdapter == null) {
                recyclerAdapter = new ConvertedBuyerAdapter(this, mList_sorted);
            } else {
