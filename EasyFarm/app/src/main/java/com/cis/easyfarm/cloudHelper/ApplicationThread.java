...
public final class ApplicationThread {
    ...
    private static boolean testMode = false;
             ...
             */
            public final static Future<?> bgndPost(final String clazz, final String msg, final int priority, final Runnable runable) {
                final Runnable runner = new PriorityExecutor.Important() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            CommonUtils.appendLog(LOG_TAG, "BackgroundPost", ex + "");
            ...
            public static Runnable nuiPost(final String clazz, final String msg, final Runnable runable, final long delay) {
                final Runnable runner = new Runnable() {
                    public void run() {
                        ...
                        try {
                            ...
                            Log.d(LOG_TAG, msg1);
                            CommonUtils.appendLog(LOG_TAG, "BackgroundPost", msg1);
                ...
                final Runnable runner = new Runnable() {
                    public void run() {
                        ...
                        try {
                            ...
                            Log.e(LOG_TAG, LOG_TAG, ex);
                            CommonUtils.appendLog(LOG_TAG, "DB Post", ex + "");
                        } finally {
                            final String msg1 = "DB THREAD " + (null == msg ? "" : msg) + " (" + (System.nanoTime() - startTime) / 1000000 + "ms)";
                            Log.d(LOG_TAG, msg1);
                            CommonUtils.appendLog(LOG_TAG, "DB Post", msg1);
                        }
                    }
                };
                ...
                final Runnable runner = new Runnable() {
                    public void run() {
                        ...
                        try {
                            ...
                            Log.e(LOG_TAG, LOG_TAG, ex);
                            CommonUtils.appendLog(LOG_TAG, "UI Post", ex + "");
                        } finally {
                            final String msg1 = "UI THREAD " + (null == msg ? "" : msg) + " (" + (System.nanoTime() - startTime) / 1000000 + "ms)";
                            Log.d(LOG_TAG, msg1);
                            CommonUtils.appendLog(LOG_TAG, "UI Post", msg1);
        ...
        public final void add(final Object observer) {
            synchronized (observers) {
                ...
                if (observers.contains(observer)) {
                    ...
                    CommonUtils.appendLog(LOG_TAG, "Add",  Log.getStackTraceString(new Throwable()));
                    return;
                }
        ...
        public final void remove(final Object observer) {
            synchronized (observers) {
                if (!observers.contains(observer)) {
                    ...
                    CommonUtils.appendLog(LOG_TAG, "Remmove", Log.getStackTraceString(new Throwable()));
                    return;
                }
    ...
    public static class LoggingRunnable implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                Log.d(LOG_TAG, msg1);
                CommonUtils.appendLog(LOG_TAG, "Run", msg1);
