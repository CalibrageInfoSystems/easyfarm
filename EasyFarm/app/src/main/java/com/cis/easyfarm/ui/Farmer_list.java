...
public class Farmer_list extends AppCompatActivity {
   ...
   // List<Farmer> farmerDetails;
    ...
    FarmerRecyclerAdapter recyclerAdapter;
    Toolbar toolbar;
    EditText et_search;
...
//        LinearLayoutManager layoutManager = new LinearLayoutManager(context);
 ...
 dataAccessHandler = new DataAccessHandler(context);
  ...
  Log.d("FarmerDetails====", mFarmersList.size() + "");
        ...
        recyclerAdapter = new FarmerRecyclerAdapter(context,mFarmersList);
    ...
    public void doSearch(String searchQuery) {
        ...
        if (!TextUtils.isEmpty(searchQuery)) {
            ...
            if (recyclerAdapter == null) {
                recyclerAdapter = new FarmerRecyclerAdapter(this, mList_sorted);
            } else {
