...
public class buyerIDProofAdapter extends RecyclerView.Adapter<buyerIDProofAdapter.MyHolder>{

    private Context mContext;
    private List<IdentityProof> landlordIdProofList;
    private buyerIDProofAdapter.idProofsClickListener idProofsClickListener;
    private LinkedHashMap<String, String> idProofsData;


    public buyerIDProofAdapter(Context mContext, List<IdentityProof> idProofsPair, LinkedHashMap<String, String> idProofsData) {
        this.mContext = mContext;
        this.landlordIdProofList = idProofsPair;
        this.idProofsData = idProofsData;
    }
    @Override
    public buyerIDProofAdapter.MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater inflater = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View bookingView = inflater.inflate(R.layout.buyeridproofadapter, null);
        buyerIDProofAdapter.MyHolder myHolder = new buyerIDProofAdapter.MyHolder(bookingView);
        return myHolder;
    }

    @Override
    public void onBindViewHolder(buyerIDProofAdapter.MyHolder holder, final int position) {
    ...
    public void setIdProofsClickListener(buyerIDProofAdapter.idProofsClickListener idProofsClickListener) {
