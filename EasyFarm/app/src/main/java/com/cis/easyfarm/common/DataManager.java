...
public class DataManager<T> {
    ...
    public static final String RECMND_FERTILIZER_SCREEN = "recmnd_fertilizer_screen";
    ...
    public static final String LANDLORD_IDPROOFS_DATA="IdentityProofs";
    ...
    public static final String NEW_COMPLAINT_DETAILS = "new_complaint";
