...
public class EditBuyer extends AppCompatActivity implements buyerpersonaldetails.OnStepOneListener, buyerprofdetails.OnStepTwoListener, buyerbankDetails.OnStepThreeListener, buyerIdendityProofs.OnStepFourListener {
    ...
    public void onBackPressed(Fragment fragment) {
        ...
        if (fragment instanceof buyerprofdetails) {
            mViewPager.setCurrentItem(0, true);
        }else if (fragment instanceof buyerIdendityProofs) {
            mViewPager.setCurrentItem(1, true);
        }
        else if (fragment instanceof buyerbankDetails) {
    ...
    public void onNextPressed(Fragment fragment) {
        ...
        if (fragment instanceof buyerpersonaldetails) {
            mViewPager.setCurrentItem(1, true);

        } else if (fragment instanceof buyerprofdetails) {
            mViewPager.setCurrentItem(2, true);
        }
        else if (fragment instanceof buyerIdendityProofs) {
...
//    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    return buyerpersonaldetails.newInstance("", "");

                case 1:
                    return buyerprofdetails.newInstance("", "");

                case 2:
                    return buyerIdendityProofs.newInstance("", "");
                case 3:
                    return buyerbankDetails.newInstance("", "");
            }
