...
public class HttpClient {
    ...
    public static Request.Builder buildRequest(String url, String method, RequestBody body) {
        ...
        CommonUtils.appendLog(LOG_TAG, "Request.Builder buildRequest", encodedUrl + "");

        URL requestUrl = null;
        try {
            requestUrl = new URL(encodedUrl);
        } catch (Exception ignored) {
            CommonUtils.appendLog(LOG_TAG, "Request.Builder buildRequest", ignored.getMessage());
    ...
    public static String encodeURL(String url) {
        ...
        try {
            ...
            CommonUtils.appendLog(LOG_TAG,"encodeURL", e.getMessage());
...
// clone buffer before reading from it
            ...
            CommonUtils.appendLog(LOG_TAG,"encodeURL", responseBodyString);
     ...
     * @param onComplete
     */
    public static synchronized void  postDataToServerjson(final String url, final JSONObject jsonObject, final ApplicationThread.OnComplete onComplete) {
