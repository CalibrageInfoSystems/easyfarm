...
//        LinearLayoutManager layoutManager = new LinearLayoutManager(context);
    ...
    private void setViews() {
        ...
        mFarmersList = (List<Farmer>) dataAccessHandler.getfarmerDetails(Queries.getInstance().getprosFarmerDetails(), 1);

 Log.d("FarmerDetails====", mFarmersList.size() + "");
        ...
        recyclerAdapter = new RecyclerAdapter(context,mFarmersList);
    ...
    public void doSearch(String searchQuery) {
        ...
        if (!TextUtils.isEmpty(searchQuery)) {
            ...
            if (recyclerAdapter == null) {
                recyclerAdapter = new RecyclerAdapter(this, mList_sorted);
            } else {
