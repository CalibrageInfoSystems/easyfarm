...
public class ConvertedFarmersActivity extends AppCompatActivity {
    ...
    ConvertedFarmerAdapter recyclerAdapter;
    Toolbar toolbar;
    EditText et_search;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_converted_farmers);
    ...
    private void setViews() {
        ...
        recyclerAdapter = new ConvertedFarmerAdapter(context,mFarmersList);
    ...
    public void doSearch(String searchQuery) {
        ...
        if (!TextUtils.isEmpty(searchQuery)) {
            ...
            if (recyclerAdapter == null) {
                recyclerAdapter = new ConvertedFarmerAdapter(this, mList_sorted);
            } else {
