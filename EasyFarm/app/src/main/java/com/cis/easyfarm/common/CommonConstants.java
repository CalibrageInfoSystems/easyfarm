...
public class CommonConstants {
    ...
    public static String plotownership = "";
    public static String educationName = "";
    public static String educationQualificationType = "";
    ...
    public static String DATE_FORMAT_DDMMYYYY_THHMMSS_SSS ="yyyy-MM-dd'T'HH:mm:ssZ";
    ...
    public static String getEducationQualificationTypeId = "";
    public static String plotStatusId = "";
    public static String plotStatusdesc = "";
    public static String insuranceStatus = "";
    public static String insuranceStatustext = "";

    public static String SinsuranceStatus = "";
...
//    public static int CanalOthersID = 131;
    ...
    public static int User_Updated = 118;
    public static int Identity_Proof_Added = 121;
    public static int Identity_Proof_Updated = 129;
    public static int Bank_Details_Added = 119;
    public static int Plot_Updated = 131;
    public static int SoildetailsupdatedforPlot = 133;
    public static int PowerdetailsupdatedforPlot = 134;
    public static int IrrigationdetailsupdatedforPlot = 135;
