...
public class BuyerDetails extends AppCompatActivity {
    ...
    private void setViews() {
        ...
        mFarmersList = (List<Farmer>) dataAccessHandler.getfarmerDetails(Queries.getInstance().getprosBuyerDetails(), 1);
        ...
        recyclerAdapter = new BuyersAdapter(context,mFarmersList);
    ...
    public void doSearch(String searchQuery) {
        ...
        if (!TextUtils.isEmpty(searchQuery)) {
            ...
            if (recyclerAdapter == null) {
                recyclerAdapter = new BuyersAdapter(this, mList_sorted);
            } else {
